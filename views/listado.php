                ...
                <tbody>
                    <tr>
                        ...
                        foreach ($pedidos as $pedido) { ?>
                            ...
                            <td><a href="menu.php?op=eliminar&mesa=<?php echo $pedido->getMesa() ?>">eliminar</a></td>
                    </tr>
                <?php    } ?>
                </tbody>
            </table>
            <button type="button" class="btn btn-primary" onclick="location='menu.php?op=agregar'">Agregar Pedido</button>
            <div class="card-footer text-muted"> <a href="menu.php?op=inicio">volver al Menú</a></div>
        </body>
